			...
			<main>
				<form>
					<div class="row">
						...
						<input type="text" id="title" placeholder="The Note Title" value="<?php echo $the_note['title'] ?>">
					</div>
					<div class="row">
						<label for="content">Content</label>
						<textarea id="content" placeholder="Content"><?php echo $the_note['content'] ?></textarea>
					</div>
					<div class="row col">
						<div class="col-50">
